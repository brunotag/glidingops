...
<?php if (true) {
    ...
    }echo "type='text' ";echo "name='name_i' ";echo "Value='";echo $name_f;echo "' ";echo "maxlength='40'";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($acronym_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='acronym_i' ";echo "Value='";echo $acronym_f;echo "' ";echo "maxlength='1'";echo ">";echo "</td>";echo "<td>";
