...
function getJuniorClass($db,$org)
{
    return getClassId($db, $org, 'Junior');
}
function getShortTermClass($db,$org)
{
    return getClassId($db, $org, 'Short Term');
}
function getNonFlyingClass($db,$org)
{
    return getClassId($db, $org, 'Non Flying');
}
...
function getTowPlaneType($db,$org)
{
    return getAircraftType($db, $org, 'Tow Plane');
}
...
function getTowLaunchType($db)
{
    return getLaunchType('Tow Plane');
}
function getSelfLaunchType($db)
{
    return getLaunchType('Self Launch');
}
function getWinchLaunchType($db)
{
    return getLaunchType('Winch');
}
