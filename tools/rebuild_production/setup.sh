...
echo ""
echo "IMPORTANT: Before switching DNS, see README.md step 4 for side-by-side"
echo "verification using a local hosts file override."
echo ""
...
echo "   See README.md step 9 for setup commands."
echo ""
echo "8. DNS"
