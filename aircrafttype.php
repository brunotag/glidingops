    ...
    if ($error != 1) {
        ...
        else
        {
            ...
            if ($_POST["tran"] == "Create") {
                ...
                if ($_SESSION['security'] & 128) {       if ($org_f ==0) { $Q .= "null"; 
                } else{$Q .= "'";$Q .= $org_f;$Q .= "'";
                }
                }else{$Q.=$_SESSION['org'];
                }
...
<?php if (true) {
    ...
    }echo "type='text' ";echo "name='name_i' ";echo "Value='";echo $name_f;echo "' ";echo "maxlength='20'";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
