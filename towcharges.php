    ...
    if ($error != 1) {
        ...
        else
        {
            ...
            if (isset($_POST["tran"]) ) {if ($_POST["tran"] == "Update") {
                    ...
                    $Q .= "'" . $club_glider_f . "'";
                    $Q .= ",member_class=";
                    if ($member_class_f ==0) { $Q .= "null"; 
                    } else {$Q .= "'";$Q .= "$member_class_f"; $Q .= "'"; 
                    }
                    $Q .= ",effective_from=";
                    $Q .= "'" . $effective_from_f . "'";
                    $Q .= ",cost=";
...
<?php if (true) {
    ...
    else
    {
        ...
        $qs= "SELECT * FROM aircraft";if($_SESSION['org'] > 0) {$qs .= " WHERE aircraft.org = " . $_SESSION['org'] . " ";
        }$qs .= " ORDER BY rego_short ASC";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($type_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='type_i' ";echo "Value='";echo $type_f;echo "' ";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($height_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='height_i' ";echo "Value='";echo $height_f;echo "' ";echo ">";echo "</td>";echo "<td>";
    echo $height_err; echo "</td></tr>";
}
?>
<?php if (true) {
    echo "<tr><td class='desc'>CLUB GLIDER</td><td></td>";
    echo "<td><input type='checkbox' name='club_glider_i[]' Value='1' ";if ($club_glider_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    {
        echo "<option value='0'></option>";
        $qs= "SELECT * FROM membership_class";if($_SESSION['org'] > 0) {$qs .= " WHERE membership_class.org = " . $_SESSION['org'] . " ";
...
<?php if (true) {
    ...
    }echo "type='text' ";echo "name='cost_i' ";echo "Value='";echo $cost_f;echo "' ";echo ">";echo "</td>";echo "<td>";
