...
if (true){echo "<td class='right'><a href='/img/members/";echo intval($row[0]);echo ".jpg' target='_blank'><img width='50' src='/img/members/";echo intval($row[0]);echo ".jpg' alt='' onerror=\"this.src='/img/noprofile.png'\"/></a> </td>";}
  echo "</tr>";
}
?>
</tbody>
