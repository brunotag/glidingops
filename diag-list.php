...
}echo " onclick=";echo "\"";echo "location.href='diag-list.php?col=1'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "ID";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 2) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='diag-list.php?col=2'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "CREATE TIME";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 3) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='diag-list.php?col=3'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "DIAG DATA";echo "</th>";
}
?>
</tr>
<?php
...
while ($row = mysqli_fetch_array($r) )
{
    ...
    }  echo "'>";if (true) {echo "<td class='right'>";echo "<a href='diag.php?id=";echo $row[0];echo "'>";echo $row[0];echo "</a>";echo "</td>";
    }
