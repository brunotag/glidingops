...
}echo " onclick=";echo "\"";echo "location.href='group_member-list.php?col=1'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "Group Id";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 2) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='group_member-list.php?col=2'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "Member Id";echo "</th>";
}
?>
</tr>
<?php
...
while ($row = mysqli_fetch_array($r) )
{
    ...
    }  echo "'>";if (true) {echo "<td class='right'>";echo $row[0];echo "</td>";
    }
