    ...
    if ($error != 1) {
        ...
        else
        {
            ...
            if (isset($_POST["tran"]) ) {if ($_POST["tran"] == "Update") {
                    ...
                    $Q .= "'" . $userid_f . "'";
                    $Q .= ",memberid=";
                    if ($memberid_f ==0) { $Q .= "null"; 
                    } else {$Q .= "'";$Q .= "$memberid_f"; $Q .= "'"; 
                    }
                    $Q .= ",description=";
...
<?php if (true) {
    ...
    {
        $qs= "SELECT * FROM users";if($_SESSION['org'] > 0) {$qs .= " WHERE users.org = " . $_SESSION['org'] . " ";
        }$qs .= " ORDER BY usercode ASC";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($description_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='description_i' ";echo "size='100' ";echo "Value='";echo $description_f;echo "' ";echo "maxlength='100'";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
