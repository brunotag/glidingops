...
require_once __DIR__ . '/helpers/permissions.php'; require_perm('tracking.view');
?>
<!DOCTYPE HTML>
<html>
...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($trip_id_f)) {
      if (!is_numeric($trip_id_f)) {
        $trip_id_err = "TRIP ID is not numeric";
        $error = 1;
      }
    }
    ...
    if (!empty($point_id_f)) {
      if (!is_numeric($point_id_f)) {
        $point_id_err = "POINT ID is not numeric";
        $error = 1;
      }
    }
  ...
  <div id='divform'>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
      <table>
        ...
        <?php if (true) {
          ...
          if (mysqli_connect_errno()) {
            ...
            if ($_SESSION['org'] > 0) {
              $qs .= " WHERE users.org = " . $_SESSION['org'] . " ";
            }
            $qs .= " ORDER BY name ASC";
        ...
        <?php if (true) {
          ...
          echo "<td>";
          echo "<input ";
          if (strlen($trip_id_err) > 0) echo "class='err' ";
          echo "type='text' ";
          echo "name='trip_id_i' ";
          echo "Value='";
          echo $trip_id_f;
        ...
        <?php if (true) {
          ...
          echo "<td>";
          echo "<input ";
          if (strlen($glider_err) > 0) echo "class='err' ";
          echo "type='text' ";
          echo "name='glider_i' ";
          echo "Value='";
          echo $glider_f;
        ...
        <?php if (true) {
          ...
          echo "<td>";
          echo "<input ";
          if (strlen($point_id_err) > 0) echo "class='err' ";
          echo "type='text' ";
          echo "name='point_id_i' ";
          echo "Value='";
          echo $point_id_f;
          echo "' ";
          echo ">";
        ...
        <?php if (true) {
          ...
          echo "<td>";
          echo "<input ";
          if (strlen($point_time_milli_err) > 0) echo "class='err' ";
          echo "type='text' ";
          echo "name='point_time_milli_i' ";
          echo "Value='";
          echo $point_time_milli_f;
          echo "' ";
          echo ">";
          echo "</td>";
          echo "<td>";
          echo $point_time_milli_err;
          echo "</td></tr>";
        }
        ?>
        <?php if (true) {
          ...
          echo "<td>";
          echo "<input ";
          if (strlen($lattitude_err) > 0) echo "class='err' ";
          echo "type='text' ";
          echo "name='lattitude_i' ";
          echo "Value='";
          echo $lattitude_f;
          echo "' ";
          echo ">";
        ...
        <?php if (true) {
          ...
          echo "<td>";
          echo "<input ";
          if (strlen($longitude_err) > 0) echo "class='err' ";
          echo "type='text' ";
          echo "name='longitude_i' ";
          echo "Value='";
          echo $longitude_f;
          echo "' ";
          echo ">";
        ...
        <?php if (true) {
          ...
          echo "<td>";
          echo "<input ";
          if (strlen($altitude_err) > 0) echo "class='err' ";
          echo "type='text' ";
          echo "name='altitude_i' ";
          echo "Value='";
          echo $altitude_f;
          echo "' ";
          echo ">";
        ...
        <?php if (true) {
          ...
          echo "<td>";
          echo "<input ";
          if (strlen($accuracy_err) > 0) echo "class='err' ";
          echo "type='text' ";
          echo "name='accuracy_i' ";
          echo "Value='";
          echo $accuracy_f;
          echo "' ";
          echo ">";
      ...
      <table>
        <tr>
          <td><input type="submit" name='tran' value='<?php echo $trantype; ?>'></td>
          <td><?php if ($trantype == "Update") echo "<input type='submit' name = 'del' value = 'Delete'>"; ?></td>
          <td></td>
          <td></td>
        </tr>
      </table>
