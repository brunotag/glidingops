...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($rego_short_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='rego_short_i' ";echo "size='10' ";echo "Value='";echo $rego_short_f;echo "' ";echo "maxlength='3'";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($spotkey_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='spotkey_i' ";echo "size='40' ";echo "Value='";echo $spotkey_f;echo "' ";echo "maxlength='40'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($polltimelast_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='polltimelast_i' ";echo "size='8' ";echo "Value='";echo $polltimelast_f;echo "' ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($polltimeall_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='polltimeall_i' ";echo "size='8' ";echo "Value='";echo $polltimeall_f;echo "' ";echo ">";echo "</td>";echo "<td>";
