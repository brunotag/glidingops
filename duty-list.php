...
}echo " onclick=";echo "\"";echo "location.href='duty-list.php?col=1'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "ID";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 2) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='duty-list.php?col=2'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "DUTY";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 3) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='duty-list.php?col=3'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "DATE";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 4) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='duty-list.php?col=4'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "MEMBER";echo "</th>";
}
?>
</tr>
<?php
...
while ($row = mysqli_fetch_array($r) )
{
    ...
    }  echo "'>";if (true) {echo "<td class='right'>";echo "<a href='Roster?id=";echo $row[0];echo "'>";echo $row[0];echo "</a>";echo "</td>";
    }
    if (true) {echo "<td>";echo $row[1];echo "</td>";
    }
    if (true) {echo "<td>";if ($row[2]!=0) {$localdate_d=new DateTime($row[2]); echo $localdate_d->format('D d/m/Y');
    }echo "</td>";
    }
