...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($status_name_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='status_name_i' ";echo "Value='";echo $status_name_f;echo "' ";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
