...
}echo " onclick=";echo "\"";echo "location.href='scheme_subs-list.php?col=1'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "ID";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 2) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='scheme_subs-list.php?col=2'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "Member";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 3) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='scheme_subs-list.php?col=3'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "Start";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 4) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='scheme_subs-list.php?col=4'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "End";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 5) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='scheme_subs-list.php?col=5'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "Incentive Scheme";echo "</th>";
}
?>
</tr>
<?php
...
while ($row = mysqli_fetch_array($r) )
{
    ...
    }  echo "'>";if (true) {echo "<td class='right'>";echo "<a href='SubsToScheme?id=";echo $row[0];echo "'>";echo $row[0];echo "</a>";echo "</td>";
    }
