...
<head>
<style><?php $inc = "./orgs/" . $org . "/heading2.css"; require $inc; ?></style>
<style>
...
<?php if (true) {
    ...
    }echo "type='text' ";echo "name='name_i' ";echo "size='30' ";echo "Value='";echo $name_f;echo "' ";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($location_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='location_i' ";echo "size='40' ";echo "Value='";echo $location_f;echo "' ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($amount_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='amount_i' ";echo "size='8' ";echo "Value='";echo $amount_f;echo "' ";echo ">";echo "</td>";echo "<td>";
    echo $amount_err; echo "</td></tr>";
}
?>
<?php if (true) {
    echo "<tr><td class='desc'>CHARGE EVERY FLIGHT</td><td></td>";
    echo "<td><input type='checkbox' name='every_flight_i[]' Value='1' ";if ($every_flight_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='max_once_per_day_i[]' Value='1' ";if ($max_once_per_day_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='monthly_i[]' Value='1' ";if ($monthly_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($comments_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='comments_i' ";echo "size='40' ";echo "Value='";echo $comments_f;echo "' ";echo ">";echo "</td>";echo "<td>";
