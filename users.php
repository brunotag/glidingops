...
<?php if (true) {
    ...
    }echo "type='text' ";echo "name='name_i' ";echo "size='30' ";echo "Value='";echo $name_f;echo "' ";echo "maxlength='40'";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($usercode_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='usercode_i' ";echo "size='20' ";echo "Value='";echo $usercode_f;echo "' ";echo "maxlength='80'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($password_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='password_i' ";echo "size='20' ";echo "maxlength='32'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($securitylevel_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='securitylevel_i' ";echo "size='5' ";echo "Value='";echo $securitylevel_f;echo "' ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    {
        echo "<option value='0'></option>";
        $qs= "SELECT * FROM members";if($_SESSION['org'] > 0) {$qs .= " WHERE members.org = " . $_SESSION['org'] . " ";
        }$qs .= " ORDER BY displayname ASC";
        $r = mysqli_query($con, $qs);
        while($row = mysqli_fetch_array($r))
        {
            if ($member_f == $row['id']) {
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='force_pw_reset_i[]' Value='1' ";if ($force_pw_reset_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
