...
if (isset($_POST['export']))
{
    ...
    header('Content-Disposition: attachment; filename="TreasurerReportNew.csv"');
...
@media screen {
     ...
     h3 {font-size: 14px; color: #718096;}
}
...
function ModForm(){var d = document.getElementById('inform');if (null !=d)d.setAttribute("action","/TreasurerReportNew.csv");}
function ModForm2(){var d = document.getElementById('inform');if (null !=d)d.setAttribute("action","/TreasurerReportNew");}
</script>
</head>
<body>
<?php
...
<input type='submit' name='view' onclick='ModForm2()' value='View Report'>
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    echo "<h1>TREASURER'S REPORT - Option 1 (Grouped by Member)</h1>";
...
SQL;
        ...
        {
            $hasData = true;
            echo "<div class='member-header'>" . htmlspecialchars($member[3]) . "</div>";
            echo "<table class='report-table'>";
            echo "<tr>
                <th style='width:100px'>SURNAME</th>
                <th style='width:90px'>FIRST NAME</th>
            ...
            while ($flight = mysqli_fetch_array($flightsResult))
            {
                ...
                echo "<tr>";
                echo "<td class='surname'>" . htmlspecialchars($member[1]) . "</td>";
                echo "<td>" . htmlspecialchars($member[2]) . "</td>";
                echo "<td>" . $formattedDate . "</td>";
