...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($class_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='class_i' ";echo "Value='";echo $class_f;echo "' ";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
    echo $class_err; echo "</td></tr>";
}
?>
<?php if (true) {
    echo "<tr><td class='desc'>Disiplay on Message Broadcast Screeen</td><td></td>";
    echo "<td><input type='checkbox' name='disp_message_broadcast_i[]' Value='1' ";if ($disp_message_broadcast_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='dailysheet_dropdown_i[]' Value='1' ";if ($dailysheet_dropdown_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='email_broadcast_i[]' Value='1' ";if ($email_broadcast_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
