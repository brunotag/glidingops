...
require_once __DIR__ . '/helpers/permissions.php'; require_perm('my-flights.view');
    ...
    (function() {
        ...
        function renderFlights(flights) {
            ...
            var html = '<div class="table-responsive"><table class="table table-bordered table-condensed table-striped"><thead><tr>' +
                ...
                '<th>Comments</th><th>Charging</th><th class="text-right">IGC</th></tr></thead><tbody>';
            ...
            flights.forEach(function(row, idx) {
                ...
                html += '<td data-label="IGC" class="text-right"' + (row.track_count > 0 ? '' : ' data-empty="1"') + '>' + (row.track_count > 0 ? '<a href="' + igcLink + '">IGC</a>' : '') + '</td>';
                html += '</tr>';
            });
