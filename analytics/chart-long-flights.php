<script>
function renderLongFlights(data) {
    var ctx = document.getElementById('chart-long').getContext('2d');
    if (window._chartLong) { window._chartLong.destroy(); }
    ...
    window._chartLong = new Chart(ctx, {
        type: 'bar',
