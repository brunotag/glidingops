...
<head>
<style><?php $inc = "./orgs/" . $org . "/heading3.css"; require $inc; ?></style>
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($name_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='name_i' ";echo "size='40' ";echo "Value='";echo $name_f;echo "' ";echo "maxlength='40'";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($addr1_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='addr1_i' ";echo "size='60' ";echo "Value='";echo $addr1_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($addr2_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='addr2_i' ";echo "size='60' ";echo "Value='";echo $addr2_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($addr3_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='addr3_i' ";echo "size='60' ";echo "Value='";echo $addr3_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($addr4_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='addr4_i' ";echo "size='60' ";echo "Value='";echo $addr4_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($country_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='country_i' ";echo "size='60' ";echo "Value='";echo $country_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($contact_name_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='contact_name_i' ";echo "size='80' ";echo "Value='";echo $contact_name_f;echo "' ";echo "maxlength='80'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    }echo "type='text' ";echo "name='email_i' ";echo "size='80' ";echo "Value='";echo $email_f;echo "' ";echo "maxlength='80'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($timezone_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='timezone_i' ";echo "size='20' ";echo "Value='";echo $timezone_f;echo "' ";echo "maxlength='20'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($aircraft_prefix_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='aircraft_prefix_i' ";echo "size='5' ";echo "Value='";echo $aircraft_prefix_f;echo "' ";echo "maxlength='5'";echo ">";echo "</td>";echo "<td>";
    echo $aircraft_prefix_err; echo "</td></tr>";
}
?>
<?php if (true) {
    echo "<tr><td class='desc'>HEIGHT BASED TOW CHARGING</td><td></td>";
    echo "<td><input type='checkbox' name='tow_height_charging_i[]' Value='1' ";if ($tow_height_charging_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='tow_time_based_i[]' Value='1' ";if ($tow_time_based_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($default_location_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='default_location_i' ";echo "size='40' ";echo "Value='";echo $default_location_f;echo "' ";echo "maxlength='40'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($name_othercharges_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='name_othercharges_i' ";echo "size='20' ";echo "Value='";echo $name_othercharges_f;echo "' ";echo "maxlength='20'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($def_launch_lat_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='def_launch_lat_i' ";echo "size='15' ";echo "Value='";echo $def_launch_lat_f;echo "' ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($def_launch_lon_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='def_launch_lon_i' ";echo "size='15' ";echo "Value='";echo $def_launch_lon_f;echo "' ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($map_centre_lat_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='map_centre_lat_i' ";echo "size='15' ";echo "Value='";echo $map_centre_lat_f;echo "' ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($map_centre_lon_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='map_centre_lon_i' ";echo "size='15' ";echo "Value='";echo $map_centre_lon_f;echo "' ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($twitter_consumerKey_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='twitter_consumerKey_i' ";echo "size='60' ";echo "Value='";echo $twitter_consumerKey_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($twitter_consumerSecret_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='twitter_consumerSecret_i' ";echo "size='60' ";echo "Value='";echo $twitter_consumerSecret_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($twitter_accessToken_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='twitter_accessToken_i' ";echo "size='60' ";echo "Value='";echo $twitter_accessToken_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($twitter_accessTokenSecret_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='twitter_accessTokenSecret_i' ";echo "size='60' ";echo "Value='";echo $twitter_accessTokenSecret_f;echo "' ";echo "maxlength='60'";echo ">";echo "</td>";echo "<td>";
    echo $twitter_accessTokenSecret_err; echo "</td></tr>";
}
?>
</table>
<table>
<tr><td><input type="submit" name = 'tran' value = '<?php echo $trantype; ?>'></td><td><?php if ($trantype == "Update") { echo "<input type='submit' name = 'del' value = 'Delete'>";
                                                    }?></td><td></td><td></td></tr>
</table>
