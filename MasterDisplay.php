...
<head>
  ...
  <style>
    ...
    .buttonbig0 {
      background-image: url(MapMinus.png);
    ...
    .buttonbig1 {
      background-image: url(MapPlus.png);
      background-repeat: no-repeat;
      width: 36px;
      height: 36px;
    }
    ...
    .buttonbig2 {
      background-image: url(MapLeft.png);
      background-repeat: no-repeat;
      width: 36px;
      height: 36px;
    }
    ...
    .buttonbig3 {
      background-image: url(MapRight.png);
      background-repeat: no-repeat;
      width: 36px;
      height: 36px;
    }
    ...
    .buttonbig4 {
      background-image: url(MapDown.png);
      background-repeat: no-repeat;
      width: 36px;
      height: 36px;
    }
    ...
    .buttonbig5 {
      background-image: url(MapUp.png);
      background-repeat: no-repeat;
      width: 36px;
      height: 36px;
    }
    ...
    .buttonbig6 {
      background-image: url(MapShow.png);
      background-repeat: no-repeat;
      width: 36px;
      height: 36px;
    }
  ...
  <script>
    ...
    function xmlReplyType(xml) {
      if (null != xml) {
        ...
        var node;
        try {
          node = xml.getElementsByTagName("resp")[0].childNodes;
        } catch (err) {
          node = null;
        }
