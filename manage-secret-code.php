...
require './helpers/secret_code_helpers.php';
session_start();
...
<body>
    ...
    <div style="padding:5px">
        ...
        <?php }else if(isset($secret_code)) {?>
            <p>Secret Code: <?php echo $secret_code?></p>
            <?php //TODO: replace hardcoded url ?>
            <p>Daily Ops Url: gops.wwgc.co.nz/DailySheet.php?org=<?php echo $org?>&key=<?php echo $secret_code?></p>
        <?php }?>
    </div>
</body>
</html>
