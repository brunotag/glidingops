...
<?php if (true) {
    ...
    }echo "type='text' ";echo "name='name_i' ";echo "Value='";echo $name_f;echo "' ";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
    echo $name_err; echo "</td></tr>";
}
?>
<?php if (true) {
    echo "<tr><td class='desc'>Charge PIC</td><td></td>";
    echo "<td><input type='checkbox' name='bill_pic_i[]' Value='1' ";if ($bill_pic_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='bill_p2_i[]' Value='1' ";if ($bill_p2_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='bill_other_i[]' Value='1' ";if ($bill_other_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='requires_comment_i[]' Value='1' ";if ($requires_comment_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='other_club_i[]' Value='1' ";if ($other_club_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
