...
<?php if (true) {
    ...
    }echo "type='text' ";echo "name='name_i' ";echo "size='40' ";echo "Value='";echo $name_f;echo "' ";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($specific_glider_list_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='specific_glider_list_i' ";echo "Value='";echo $specific_glider_list_f;echo "' ";echo ">";echo "</td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($rate_glider_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='rate_glider_i' ";echo "size='8' ";echo "Value='";echo $rate_glider_f;echo "' ";echo ">";echo "</td>";echo "<td>";
    echo $rate_glider_err; echo "</td></tr>";
}
?>
<?php if (true) {
    echo "<tr><td class='desc'>PAY FOR TOWS</td><td></td>";
    echo "<td><input type='checkbox' name='charge_tow_i[]' Value='1' ";if ($charge_tow_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td><input type='checkbox' name='charge_airways_i[]' Value='1' ";if ($charge_airways_f ==1) { echo "checked";
    }echo "></td>";echo "<td>";
...
<?php if (true) {
    ...
    echo "<td>";
    echo "<input ";
    if (strlen($cost_err) > 0) { echo "class='err' ";
    }echo "type='text' ";echo "name='cost_i' ";echo "size='9' ";echo "Value='";echo $cost_f;echo "' ";echo ">";echo "</td>";echo "<td>";
