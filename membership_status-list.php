...
}echo " onclick=";echo "\"";echo "location.href='membership_status-list.php?col=1'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "ID";echo "</th>";
}
if (true) {echo '<th ';if ($colsort == 2) { echo "class='colsel'";
}echo " onclick=";echo "\"";echo "location.href='membership_status-list.php?col=2'";echo "\"";echo " style='cursor:pointer;'";echo ">";echo "TYPE";echo "</th>";
}
?>
</tr>
<?php
...
while ($row = mysqli_fetch_array($r) )
{
    ...
    }  echo "'>";if (true) {echo "<td class='right'>";echo "<a href='membership_status.php?id=";echo $row[0];echo "'>";echo $row[0];echo "</a>";echo "</td>";
    }
